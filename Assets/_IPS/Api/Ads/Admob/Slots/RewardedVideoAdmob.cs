...
namespace IPS.Api.Ads {
    internal class RewardedVideoAdmob : AdmodSlotBase {
#if ADMOB
        ...
        public RewardedVideoAdmob(string slotID, bool enableLog, Action onAdLoaded) : base(slotID, enableLog) {
        ...
        protected override void DoRequest() {
            ...
            RewardedAd.Load(adSlotId, CreateAdRequest(), OnAdLoadCallback);
#endif
        }

#if ADMOB
        private void OnAdLoadCallback(RewardedAd ad, LoadAdError err) {
            if (err != null || ad == null) {
